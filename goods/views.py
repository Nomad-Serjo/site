...
GoodImagesFormset = inlineformset_factory(Good, GoodImage, can_order=True, fields=['image', 'good',])
    ...
    def post(self, request, *args, **kwargs):
        ...
        if self.form.is_valid():
            ...
            if self.formset.is_valid():
                ...
                return redirect(reverse("goods_index", kwargs={"pk": self.good.category.pk}) + "?page=" + self.request.GET[
